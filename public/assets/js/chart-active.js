$(document).ready(function () {
     ...
     function generateChart() {
          ...
          var ctx = document.getElementById('UserHistoryChart');
          if (ctx) {
               ctx.getContext("2d");
               var UserHistoryChart = new Chart(ctx, {
                    type: 'line',
                    data: {
          ...
          TotalUser
          -------------------------- */
          var ctx = document.getElementById('TotalUser');
          if (ctx) {
               var ctx = document.getElementById('TotalUser').getContext("2d");
               var TotalUser = new Chart(ctx, {
                    type: 'bar',
                    data: {
