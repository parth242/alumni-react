...
function App() {
	...
	return (
		<div
			...
			<div
				id="contentDiv"
				className={`px-8 py-5 mb-10 mr-5 border border-border rounded-3xl float-right inline-block min-h-[calc(100vh-136px)] transition-[width] duration-300 dark:bg-dark2 dark:text-darkPrimary ${
					showSidebar
